...
Route::middleware(['auth', 'employee', 'passwordChanged'])->group(function () {
    ...
    Route::prefix('inventory')->name('inventory.')->group(function () {
        ...
        Route::post('moves/update-cost/{product}', [MoveController::class, 'updateProductCost'])->name('moves.update-cost');
        Route::get('moves/cost-adjustment', [MoveController::class, 'costAdjustment'])->name('moves.cost-adjustment');
        Route::post('moves/cost-adjustment', [MoveController::class, 'updateCosts'])->name('moves.cost-adjustment.update');
    ...
    Route::prefix('restaurant-pos')->name('restaurant-pos.')->group(function () {
        Route::middleware('moduleAccess')->group(function () {
            ...
            Route::post('/split-bill/{order}', [PosController::class, 'splitBill'])->name('split-bill');
            ...
            Route::post('/quotation-print', [PosController::class, 'quotationPrintNetwork'])->name('quotation-print');
            Route::post('/receipt/quotation', [PosController::class, 'quotationReceipt'])->name('receipt.quotation');
    ...
    Route::prefix('employees')->name('employees.')->group(function () {
        ...
        Route::middleware('moduleAccess')->group(function () {
            ...
            Route::get('/advances/employee/{employee}', [EmployeeAdvanceController::class, 'ledger'])->name('advances.ledger');
