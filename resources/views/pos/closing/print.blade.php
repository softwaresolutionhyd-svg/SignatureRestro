  ...
  <div class="section">
        ...
        <table class="data">
            ...
            <tbody>
                ...
                <tr>
                    <td>Credit sales ({{ $stats['credit_sales_count'] }} bills) — Credit Book, not in cash drawer</td>
                ...
                <tr>
                    <td><strong>Cash</strong> <span style="font-weight:normal;font-size:8.5pt;color:#555;">(credit sales excluded)</span></td>
