            ...
            <div class="card-body p-0">
                <div class="table-responsive">
                    <table class="table table-sm mb-0 align-middle">
                        ...
                        @endforelse
                        <tr>
                            <td class="small fw-semibold text-danger">Void Items</td>
                            <td class="text-end small">{{ $voidCount }}</td>
                            <td class="text-end small text-secondary">—</td>
                            <td class="text-center no-print">
                                <a href="{{ route('reports.sales.voids', ['from' => $from, 'to' => $to]) }}"
                                   class="btn btn-sm btn-outline-primary px-2 py-0"
                                   title="View void items / cancelled bills">
                                    <i class="bi bi-eye"></i>
                                </a>
                            </td>
                        </tr>
